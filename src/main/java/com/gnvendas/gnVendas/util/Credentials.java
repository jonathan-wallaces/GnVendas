...
public class Credentials {
	...
	public Credentials(JSONObject credentials, String method, String authorizeRoute) throws Exception {
		...
		URL link = new URL("https://sandbox.gerencianet.com.br/v1/authorize");
